  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="grid-section relative white-background h-96 mb-10 px-32">
        ...
        <section className="px-32 myb-32 mt-96">
        ...
        <section className=" my-32 bg-green-500 text-white px-72 pt-20 pb-52">
